...
using Turismul_In_Capitalele_Europene.Services.Repository;
...
namespace Turismul_In_Capitalele_Europene
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<CapitalaService>();
            services.AddScoped<CapitalaTuristService>();
            services.AddScoped<IntrebareService>();
            services.AddScoped<NivelService>();
            services.AddScoped<RaspunsService>();
            services.AddScoped<TuristService>();
            services.AddScoped<UtilizatorService>();
            services.AddScoped<RegisterLoginServices>();

            services.AddDbContext<CapitaleEuropeneDbContext>(options =>
            ...
            services.AddIdentity<Utilizator, IdentityRole>()
