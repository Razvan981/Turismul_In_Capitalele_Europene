...
namespace Turismul_In_Capitalele_Europene.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        RegisterLoginServices register;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await register.Register(user, Input.Password);
                
                if (result.Succeeded)
                {
                    var res = _userManager.AddToRoleAsync(user, "Utilizator").GetAwaiter().GetResult();
